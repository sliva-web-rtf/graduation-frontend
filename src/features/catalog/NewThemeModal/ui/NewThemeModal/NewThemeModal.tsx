import { InputAdornment, Modal, Paper, Stack, Typography } from '@mui/material';
                ...
                <Stack direction="row" spacing={3} alignItems="flex-start" className={styles.modal}>
                    ...
                    <form>
                        <Stack component={Paper} className={styles.content} spacing={4} elevation={0}>
                            ...
                            <Stack spacing={2}>
                                <InputField label="Название темы" placeholder="Введите название темы исследования" />
                                <InputField
                                    label="Описание темы"
                                ...
                                />
                                <InputField label="Ключевые слова" placeholder="Начните писать и выберите из списка" />
                            </Stack>
