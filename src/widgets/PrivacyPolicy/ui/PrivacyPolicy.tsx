        ...
        <Stack spacing={8}>
            ...
            <Stack spacing={2}>
                ...
                <Stack spacing={2} px={4}>
                    ...
                    <Typography>2.10. Пользователь — любой посетитель веб-сайта httpsː//thismywebsite·com.</Typography>
                    <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">3. Основные права и обязанности Оператора</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>3.1. Оператор имеет право:</Typography>
                    ...
                    <Typography>3.2. Оператор обязан:</Typography>
                    <Stack spacing={1} px={4}>
                        <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">4. Основные права и обязанности субъектов персональных данных</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>4.1. Субъекты персональных данных имеют право:</Typography>
                    <Stack spacing={1} px={4}>
                        <Typography>
                        ...
                        <Typography>— на осуществление иных прав, предусмотренных законодательством РФ.</Typography>
                    </Stack>
                    <Typography>4.2. Субъекты персональных данных обязаны:</Typography>
                    <Stack spacing={1} px={4}>
                        <Typography>— предоставлять Оператору достоверные данные о себе;</Typography>
                        <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">5. Принципы обработки персональных данных</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">6. Цели обработки персональных данных</Typography>
                <Stack spacing={2} px={4}>
                    <TableContainer>
                        <Table size="small">
                            <TableBody>
                                <TableRow>
                                    <TableCell>
                                        <Typography>Цель обработки</Typography>
                                    </TableCell>
                                    <TableCell>
                                        <Typography>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Typography>философские убеждения</Typography>
                                    </TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell>
                                        <Typography>Правовые основания</Typography>
                                    </TableCell>
                                    <TableCell>
                                        <Typography>
                                ...
                                <TableRow>
                                    <TableCell>
                                        <Typography>Виды обработки персональных данных</Typography>
                                    </TableCell>
                                    <TableCell>
                                        <Typography>Передача персональных данных</Typography>
                                    </TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">7. Условия обработки персональных данных</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">10. Трансграничная передача персональных данных</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">11. Конфиденциальность персональных данных</Typography>
                <Typography>
            ...
            <Stack spacing={2}>
                <Typography variant="h2">12. Заключительные положения</Typography>
                <Stack spacing={2} px={4}>
                    <Typography>
